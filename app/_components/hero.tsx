    ...
    <div className="bg-radial-gradient text-white flex flex-col">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-16">
        <div className="flex gap-6 justify-center w-full items-center">
          ...
          <div className="flex px-2 -space-x-3 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="80"
              height="50"
              viewBox="0 0 160 160"
              className="-ml-6 text-gray-900 dark:text-gray-100" // Tailwind dark mode classes
            >
              <rect
                width="9.631"
                height="40.852"
                ...
                className="fill-current" // This will inherit the text color
              />
              {/* Other rect elements with same class */}
              <rect
                width="9.631"
                height="40.852"
                rx="4.816"
            ...
            <p className="text-black dark:text-white text-[9.4px] uppercase tracking-tight">
              Drizzle
            </p>
          </div>
          <hr className="h-[20px] w-px bg-black dark:bg-zinc-500/40" />
